...
final class StudentCourseController
{
    ...
    private function studentRules(bool $create): array
    {
        ...
        return [
            ...
            'initial_course.initial_cost.amount_minor' => ['required_with:initial_course.initial_cost', 'integer', 'min:0'],
            'initial_course.initial_cost.currency' => ['required_with:initial_course.initial_cost', 'string', 'size:3', 'regex:/^[A-Za-z]{3}$/'],
    ...
    private function courseRules(bool $create): array
    {
        ...
        return [
            ...
            'initial_cost' => $create ? ['sometimes', 'nullable', 'array'] : ['prohibited'],
            'initial_cost.amount_minor' => $create ? ['required_with:initial_cost', 'integer', 'min:0'] : ['prohibited'],
            'initial_cost.currency' => $create ? ['required_with:initial_cost', 'string', 'size:3', 'regex:/^[A-Za-z]{3}$/'] : ['prohibited'],
