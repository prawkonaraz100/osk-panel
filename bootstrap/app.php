...
return Application::configure(basePath: dirname(__DIR__))
    ->withCommands([GoLiveEvidenceCommand::class, OperationalAlertSmokeCommand::class, ProductionOperationsSmokeCommand::class, ProductionPreflightCommand::class, ReconciliationAlertSmokeCommand::class, RetentionRunCommand::class])
    ->withRouting(
