...
const isRegistrationRoute = window.location.pathname === '/register'
...
<template>
  <RegistrationWorkspace v-if="isRegistrationRoute" />
  <AuthWorkspace v-else-if="isAuthRoute" />
