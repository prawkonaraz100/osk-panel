...
final class Stage4CommerceCandidateKeyPrerequisiteTest extends TestCase
{
    public function test_order_items_expand_contains_exact_license_product_lineage_column_before_candidate_key_gate(): void
    {
        ...
        $this->assertTrue(
            ...
            'DB-COM-004 exact purchase lineage requires order_items.license_product_id before MIG-CK-COMMERCE can be materialized.',
        );
        ...
        $this->assertSame(
            ...
            'Prerequisite correction must not prematurely materialize MIG-CK-COMMERCE.',
        );
